...
public class AuthController extends HttpServlet {
     ...
     * 로그인 페이지 렌더링
     */
    private void renderLoginPage(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
     ...
     * 회원가입 페이지 렌더링
     */
    private void renderSignupPage(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
